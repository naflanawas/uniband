            ...
            <div className="container footer-grid">
                ...
                <div>
                    ...
                    <div className="footer-app-badges">
                        <a href="https://www.apple.com/app-store/" target="_blank" rel="noopener noreferrer" className="app-badge" aria-label="Download on App Store">
                        ...
                        <a href="https://play.google.com/store/games" target="_blank" rel="noopener noreferrer" className="app-badge" aria-label="Get it on Google Play">
